        ...
        >
          <div>
            <div className="rounded-md shadow-sm">
              <div>
                <div htmlFor="nama" className="text-sm mb-2">
                  Nama Pengguna
                </div>
                <input
                  type="text"
              ...
              <div>
                <div htmlFor="username" className="text-sm mb-2">
                  Username
                </div>
                <input
                  type="text"
              ...
              <div>
                <div htmlFor="role" className="text-sm mb-2">
                  Role
                </div>
                <select
                  type="text"
              ...
              <div>
                <div htmlFor="password" className="text-sm mb-2">
                  Password
                </div>
                <input
                  type="password"
              ...
              <div className="flex ">
                <button
                  ...
                  value="Add Pengguna"
                >
                  <div className="text-sm mb-2 text-white	h-6">
                    Tambah data User
                  </div>
                </button>
              </div>
