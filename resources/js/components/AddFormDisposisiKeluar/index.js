                      ...
                      {this.state.showForm == false ? (
                        ...
                        <div className="flex flex-row items-start p-2 ml-6 rounded-t col-span-3">
                          ...
                          <div className="flex">
                            ...
                            {console.log('SuratDetail '+this.props.SuratDetail)}
                            ...
                            {console.log('DisposisiDetail'+this.props.DisposisiDetail)}
                            {console.log('tujuanPencatatan '+this.props.tujuanPencatatan)}
                            {console.log('tujuanDisposisi '+this.props.tujuanDisposisi)}
                            {console.log('idDisposisi '+this.props.idDisposisi)} */}
                          </div>
                        </div>
...
export default connect(mapStateToProps,{})(AddFormDisposisiKeluar)
// export default AddFormDisposisiKeluar